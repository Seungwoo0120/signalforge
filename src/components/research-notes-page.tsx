  ...
  return (
    <>
      <PageHeader
        ...
        title="Strategy Interpretation Preview"
        description="Educational research notes summarize the current configuration, risk profile, and stability context. They are not generated by an AI service and are not financial advice."
      />
